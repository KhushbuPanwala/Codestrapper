...
namespace HTMLAgility
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            HtmlDocument document = web.Load("https://nhlink.net/mcq/100-top-digital-marketing-multiple-choice-questions-and-answers");
            ...
            for (int i = 0; i < questions.Count(); i++)
            {
                ...
                questionAnswer.TagName = "Digital Marketing";
            ...
            try
            {
                ...
                Tuple<string, MemoryStream> fileData = exportToExcelRepository.CreateExcelFileWithMultipleTable(dynamicDictionary, "Digital Marketing");
