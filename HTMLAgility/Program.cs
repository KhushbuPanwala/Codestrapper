    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                string path = "c:\\khushbu\\Apptitude";
                Tuple<string, MemoryStream> fileData = exportToExcelRepository.CreateExcelFileWithMultipleTable(dynamicDictionary, tagName, path);
